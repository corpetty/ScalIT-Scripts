...
#############################################################################################################
central_energy = 0.00683
number_states = 50 
total_accuracy = 5.0E-11
#############################################################################################################
...
#############################################################################################################
host = 'Robinson'
work = '/lustre/work/corepett/work'
data = '/lustre/scratch/corepett/DataFiles'
scalit = '/lustre/work/corepett/ScalIT-o3well'
...
mol = dict(
    Name=molecule,
    mass_opt=mass_label,
    mass=(14578.471659, 19437.962212),
    Rmin=(1.5, 0.0),
    Rmax=(6.0, 6.0),
    re=(2.401, 1.256),
    use_spline=True
