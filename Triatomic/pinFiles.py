...
def mkpsh(params):
    ...
    script_file = params['dirs']['run_dir'] + '/' + params['mol']['Name'] + '.sh'
...
def mkpin(params):
    ...
    work_base = params['dirs']['run_dir'] + '/'
    data_base = params['dirs']['psovbr_dir'] + '/' + 'presinc_'

    # Setting up string base for output data files of *.pin
