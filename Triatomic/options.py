...
class Options(object):
    def __init__(self,
                 dvr_type=2, use_spline='T', restrict_num_angles="F", num_res_angles=0, ngi=300, fc_flag=0,
                 cb_flag=0, abs_flag=0, s_f=3, s_job=1, s_osb=0, s_cx='F',
                 s_ndvr='T', s_st='T', s_equil_r=0, f_equil_r='fRES.dat',
        ...
        self.pin_options = self.PinOptions(dvr_type=dvr_type, use_spline=use_spline)
